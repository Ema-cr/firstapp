...
const Dashboard = () => {
  ...
  return (
    <div>
      <div>
        <button className="dashboard--button" onClick={goToBack}>
          Regresar
        </button>
        <br />
        ...
        <button className="dashboard--button" onClick={handleClickSuccess}>
          success
        </button>
        <button className="dashboard--button" onClick={handleClickInfo}>
          info
        </button>
        <button className="dashboard--button" onClick={handleClickWarning}>
          aviso
        </button>
        <button className="dashboard--button" onClick={handlerClick}>
          llamar al back
        </button>
        ...
        <MiButton
          ...
          click={goToProducts}
        />
        <MiButton text={""} icon={"Save"} click={handleNot} disabled />
        <br />
        <MiButton
          text={"cancelar"}
          icon={<FiCheck />}
